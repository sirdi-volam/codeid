...
import avatar from '../../static/avatar/unnamed.jpg'
          ...
          <nav className="header-nav">
            <ul className="header-nav_left">
              <a href="/" className="logo">
                ...
                <span className="logo-text">Codeid</span>
              </a>
              <div className="header-nav-left__search">
                ...
                <input type="search" placeholder="Поиск по блогу..." className="header-nav-left__search_input" />
              </div>
            </ul>
            <ul className="header-nav-right">
              <div className="header-nav-right__items">
                ...
                <div className="header-nav-right__items-profile">
                  ...
                  <div class="header-nav-right__items-avatar__profileArrow">
